...
func (m *MockChainReader) GetBlock(arg0 common.Hash, arg1 uint64) types.IBlock {
	m.ctrl.T.Helper()
...
func (m *MockChainReader) GetHeader(arg0 common.Hash, arg1 uint64) types.IHeader {
	m.ctrl.T.Helper()
...
func (m *MockChainReader) GetHeaderByHash(arg0 common.Hash) types.IHeader {
	m.ctrl.T.Helper()
...
func (m *MockChainReader) GetHeaderByNumber(arg0 uint64) types.IHeader {
	m.ctrl.T.Helper()
