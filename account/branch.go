...
func NewBranch(value ShardKeyType) Branch {
	return Branch{
		Value: value,
	}
}
...
func CreatBranch(shardSize ShardKeyType, shardID ShardKeyType) (Branch, error) {
