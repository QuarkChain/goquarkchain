...
func (p *PublicBlockChainAPI) GetAccountData(getAccount GetAccountDataArgs) (map[string]interface{}, error) {
	address, blockNr, includeShards := getAccount.Address, getAccount.BlockNr, getAccount.IncludeShards
