...
// private key on the given curve. The isCompressed  parameter should
...
func SignCompact(curve *sm2Curve, key *PrivateKey,
	hash []byte, isCompressedKey bool) ([]byte, error) {
	r, s, err := key.Sign(hash)
	if err != nil {
		return nil, err
	}
...
// sm2 curve in "curve". If the signature matches then the recovered public
// key will be returned as well as a boolen if the original key was compressed
// or not, else an error will be returned.
func RecoverCompact(curve *sm2Curve, signature,
...
func recoverKeyFromSignature(curve *sm2Curve, r, s *big.Int, msg []byte,
...
func signRFC6979(privkey *PrivateKey, hash []byte) (*big.Int, *big.Int, error) {
