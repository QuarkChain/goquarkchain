...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *qkcdb.MemDatabase {
	var provers []func(key []byte) *qkcdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *qkcdb.MemDatabase {
		proof := qkcdb.NewMemDatabase()
