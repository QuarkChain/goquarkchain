...
type Database struct {
	diskdb qkcdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb qkcdb.Database) *Database {
...
func NewDatabaseWithCache(diskdb qkcdb.Database, cache int) *Database {
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	if flushPreimages {
		for hash, preimage := range db.preimages {
			...
			if batch.ValueSize() > qkcdb.IdealBatchSize {
...
func (db *Database) commit(hash common.Hash, batch qkcdb.Batch) error {
