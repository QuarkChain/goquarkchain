...
type Processor interface {
	Process(block types.IBlock, statedb *state.StateDB, cfg vm.Config, txIncluded []*types.Transaction, xShardReceivedTxList []*types.CrossShardTransactionDeposit) (types.Receipts, []*types.Log, uint64, error)
}
