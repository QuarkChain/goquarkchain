...
func TestMinorBlockHeaderSerializing(t *testing.T) {
	...
	check("CoinbaseAmount", blockHeader.CoinbaseAmount.BalanceMap[NewTokenType(1)], common.Big1)
	check("CoinbaseAmount", blockHeader.CoinbaseAmount.BalanceMap[NewTokenType(2)], common.Big2)
