...
// GetOneConnById mocks base method
func (m *MockConnManager) GetOneConnById(fullShardId uint32) rpc.ISlaveConn {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOneConnById", fullShardId)
	ret0, _ := ret[0].(rpc.ISlaveConn)
	return ret0
}

// GetOneConnById indicates an expected call of GetOneConnById
func (mr *MockConnManagerMockRecorder) GetOneConnById(fullShardId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOneConnById", reflect.TypeOf((*MockConnManager)(nil).GetOneConnById), fullShardId)
}
...
func (m *MockISlaveConn) HandleNewTip(request *rpc.HandleRawMinorTip) error {
	m.ctrl.T.Helper()
