...
// AddMinorBlock mocks base method
func (m *MockISlaveConn) AddMinorBlock(request *p2p.NewBlockMinor) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddMinorBlock", request)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
...
// AddMinorBlock indicates an expected call of AddMinorBlock
func (mr *MockISlaveConnMockRecorder) AddMinorBlock(request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddMinorBlock", reflect.TypeOf((*MockISlaveConn)(nil).AddMinorBlock), request)
}

// AddBlockListForSync mocks base method
func (m *MockISlaveConn) AddBlockListForSync(request *rpc.HashList) (*rpc.ShardStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddBlockListForSync", request)
	ret0, _ := ret[0].(*rpc.ShardStatus)
	ret1, _ := ret[1].(error)
...
func (m *MockISlaveConn) SendPing(rootBlock *types.RootBlock, initializeShardSize bool) ([]byte, []*types.ChainMask, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendPing", rootBlock, initializeShardSize)
	ret0, _ := ret[0].([]byte)
...
func (mr *MockISlaveConnMockRecorder) SendPing(rootBlock, initializeShardSize interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendPing", reflect.TypeOf((*MockISlaveConn)(nil).SendPing), rootBlock, initializeShardSize)
}
