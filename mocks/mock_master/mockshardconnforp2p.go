...
func (m *MockShardConnForP2P) GetMinorBlockHeaderList(req *rpc.GetMinorBlockHeaderListRequest) (*p2p.GetMinorBlockHeaderListResponse, error) {
	m.ctrl.T.Helper()
...
// GetMinorBlockHeaderList mocks base method
func (m *MockISlaveConn) GetMinorBlockHeaderList(req *rpc.GetMinorBlockHeaderListRequest) (*p2p.GetMinorBlockHeaderListResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMinorBlockHeaderList", req)
	ret0, _ := ret[0].(*p2p.GetMinorBlockHeaderListResponse)
	ret1, _ := ret[1].(error)
