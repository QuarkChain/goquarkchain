...
type Progress struct {
	...
	CurrentBlock uint64 `json:"currentBlock"` // Current block number where sync is at
	HighestBlock uint64 `json:"highestBlock"` // Highest alleged block number in the chain
