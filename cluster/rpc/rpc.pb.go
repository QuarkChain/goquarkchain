...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type MasterServerSideOpClient interface {
	...
	MinorHead(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *masterServerSideOpClient) MinorHead(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/rpc.MasterServerSideOp/MinorHead", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MasterServerSideOpServer interface {
	...
	MinorHead(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedMasterServerSideOpServer) MinorHead(ctx context.Context, req *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MinorHead not implemented")
}
...
func _MasterServerSideOp_MinorHead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MasterServerSideOpServer).MinorHead(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.MasterServerSideOp/MinorHead",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServerSideOpServer).MinorHead(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MasterServerSideOp_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MinorHead",
			Handler:    _MasterServerSideOp_MinorHead_Handler,
		},
	},
...
type SlaveServerSideOpClient interface {
	...
	GetShardStatus(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *slaveServerSideOpClient) GetShardStatus(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/rpc.SlaveServerSideOp/GetShardStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SlaveServerSideOpServer interface {
	...
	GetShardStatus(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedSlaveServerSideOpServer) GetShardStatus(ctx context.Context, req *Request) (*Response, error) {
...
func _SlaveServerSideOp_GetShardStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SlaveServerSideOpServer).GetShardStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.SlaveServerSideOp/GetShardStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlaveServerSideOpServer).GetShardStatus(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SlaveServerSideOp_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SlaveServerSideOp_GetShardStatus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc.proto",
